...
By default I have enabled caksoylar's [zmk-rgbled-widget](https://github.com/caksoylar/zmk-rgbled-widget) on the bluetooth build, which so fantastic that anyone using a xiao ble should use it.
